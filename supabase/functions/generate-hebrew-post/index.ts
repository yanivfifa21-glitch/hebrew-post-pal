...
const PROMPT_TEMPLATES = [
  ...
  `צור פוסט טלגרם מפורט בעברית למוצר.

מבנה הפוסט:
1. כותרת מושכת עם אימוג'י אחד ושם המוצר
2. פסקה של 4-5 משפטים המתארים את המוצר:
   - מה המוצר עושה ומה הייחוד שלו
   - תכונות טכניות מרכזיות (חומרים, מידות, קיבולת, עוצמה וכד')
   - יתרונות פרקטיים (קל לשימוש, עמיד, נייד וכד')
   - למי זה מתאים או באיזה מצב זה שימושי

חוקים:
- אסור לפתוח משפט עם "זוהי", "זהו", "הוא", "היא", "מדובר ב"
- אסור: מחירים, קישורים, קריאות לפעולה
- אסור: משפטי השראה/מוטיבציה כמו "תהנו מ...", "שקט נפשי", "תשכחו מ..."
- חובה לסיים במשפט שלם עם נקודה`,

  // Prompt 2: Benefits-focused style
  `כתוב פוסט טלגרם בעברית שמדגיש יתרונות.

מבנה:
1. כותרת עם אימוג'י ושם המוצר
2. תיאור של 4-5 משפטים:
   - התכונה המרכזית של המוצר
   - 2-3 יתרונות טכניים ספציפיים (לא כלליים)
   - פרט טכני מעניין (למשל: "סוללה ל-8 שעות", "עמיד עד 50 מטר", "350 לומן")
   - סיכום קצר של הערך שהמוצר נותן

אסור:
- לפתוח עם "זוהי/זהו/הוא/היא"
- מחירים או מטבעות
- קישורים או "לחץ כאן"
- משפטים כמו "מתאים לשימוש יומיומי" או רשימות פעילויות גנריות
...
2. תיאור מפורט של 4-5 משפטים:
   - פתיחה ישירה עם התכונה הבולטת ביותר
   - מפרט טכני (גודל/משקל/חומר/עוצמה)
   - יתרון פרקטי אחד או שניים
   - משפט סיום על האיכות או הביצועים

כללים קריטיים:
- לא לפתוח משפטים עם "זהו/זוהי/הוא/היא/מדובר ב"
- לא לכלול מחירים, קישורים, או הנחיות רכישה
- לא לסיים עם "תהנו", "תשכחו", "שקט נפשי", "תאיר את" וכד'
- לסיים תמיד במשפט שלם עם נקודה`
];
