...
הוסף תיאור של 2–3 שורות: מה המוצר עושה ומה היתרונות הטכניים שלו.
הדגש יתרון מרכזי אחד או שניים של המוצר עצמו.
הוסף משפט קצר על פופולריות או שימוש נפוץ.

אסור לציין מחירים, מטבעות או סכומים כספיים.
אסור לכלול קריאה לפעולה, קישורים או הנחיות להזמנה.
אסור להוסיף משפטי השראה, מוטיבציה או פילוסופיה בסוף כמו "תשכחו מהדאגה", "תהנו מ...", "צרו לעצמכם", "תאיר את השגרה", "שקט נפשי" וכו'.
תמקד רק במוצר עצמו - מה הוא ומה הוא עושה.`,

  // Prompt 2: Recommendation style - NO CTA
  `כתוב פוסט טלגרם בעברית בסגנון המלצה.

פתח במשפט שמסביר מה המוצר עושה.
הוסף 2–3 שורות יתרונות טכניים בשפה פשוטה.
הימנע מהגזמות ומילים שיווקיות חזקות.
שלב משפט על שימוש יומיומי.

אסור לציין מחירים, מטבעות או סכומים כספיים.
אסור לכלול קישורים, קריאה לפעולה או הנחיות רכישה.
אסור לסיים עם משפטי השראה או מוטיבציה כמו "תהנו מ...", "תשכחו מ...", "צרו לעצמכם...", "שקט נפשי" וכו'.
רק עובדות על המוצר.`,

  // Prompt 3: Template style - short and readable - NO CTA
  `צור פוסט קצר לטלגרם למוצר אונליין.

הפוסט צריך להיות קצר, קריא ונעים לעין.
כלול כותרת עם אימוג'י אחד.
הוסף תיאור של עד 3 שורות בעברית טבעית - מה המוצר ומה היתרונות שלו.

אין לכלול מחירים, מספרים כספיים, קישורים או הנחיות להזמנה.
אין לסיים עם משפטים פילוסופיים או השראה כמו "תהנו", "תשכחו", "צרו לעצמכם", "שקט נפשי", "תאיר את" וכו'.
רק תיאור המוצר עצמו.`
];
